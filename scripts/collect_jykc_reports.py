...
SECTOR_KEYWORDS = {
    'agri': ['农产品','农产','玉米','豆粕','豆油','棕榈油','菜油','菜粕','白糖','棉花','鸡蛋','生猪','花生','苹果','红枣','橡胶'],
    'metals': ['金属','有色','铜','铝','锌','铅','镍','锡','氧化铝','工业硅','碳酸锂','黄金','白银'],
    'energy': ['能源化工','能化','原油','燃料油','沥青','PTA','乙二醇','苯乙烯','聚乙烯','聚丙烯','PVC','甲醇','尿素','玻璃','纯碱','纸浆'],
    'ferrous': ['黑色','建材','螺纹钢','热卷','铁矿石','焦煤','焦炭','硅铁','锰硅','不锈钢','线材'],
    'financial': ['金融','股指','国债','期货策略','宏观','策略专题'],
}

SECTOR_NAMES = {
    'agri': '农产', 'metals': '金属', 'energy': '能化',
    'ferrous': '黑色', 'financial': '金融',
}

# 品种关键词映射（与现有项目对齐）
VARIETY_KEYWORDS = {
    'agri': {'豆粕':'M','菜粕':'RM','豆油':'Y','棕榈油':'P','菜油':'OI','玉米':'C','淀粉':'CS','白糖':'SR','棉花':'CF','鸡蛋':'JD','生猪':'LH','花生':'PK','苹果':'AP','红枣':'CJ','橡胶':'RU'},
    'metals': {'铜':'CU','铝':'AL','锌':'ZN','铅':'PB','镍':'NI','锡':'SN','氧化铝':'AO','工业硅':'SI','碳酸锂':'LC','黄金':'AU','白银':'AG'},
    'energy': {'原油':'SC','燃料油':'FU','沥青':'BU','PTA':'TA','乙二醇':'EG','苯乙烯':'EB','聚乙烯':'L','聚丙烯':'PP','PVC':'V','甲醇':'MA','尿素':'UR','玻璃':'FG','纯碱':'SA','纸浆':'SP'},
